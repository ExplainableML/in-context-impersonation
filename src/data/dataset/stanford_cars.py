...
class StanfordCars(Dataset):
    def __init__(
        ...
        dataset_name = f"Multimodal-Fatima/StanfordCars_{self.split}"
    ...
    def __getitem__(self, index) -> Any:
        ...
        item.pop("Attributes_ViT_L_14_text_davinci_003_stanfordcars", None)
...
if __name__ == "__main__":
    sc = StanfordCars(cache_dir="/mnt/character-based-classification/.cache")
    item1 = sc[0]
    item2 = sc[1]
